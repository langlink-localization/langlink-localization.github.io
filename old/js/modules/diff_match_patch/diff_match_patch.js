 ...
 */
 var diff_match_patch = function() {
   ...
   */
  diff_match_patch.prototype.diff_prettyHtml1 = function(diffs) {
    var html = [];
    var pattern_amp = /&/g;
    var pattern_lt = /</g;
    var pattern_gt = />/g;
    ...
    for (var x = 0; x < diffs.length; x++) {
      ...
      switch (op) {
        case DIFF_INSERT:
          ...
          html[x] = '<span class="insert1">' + text + '</span>';
          break;
        case DIFF_DELETE:
          // html[x] = '<del style="background:#ffe6e6;">' + text + '</del>';
          html[x] = '<span class="delete1">' + text + '</span>';
          break;
        case DIFF_EQUAL:
  ...
  diff_match_patch.prototype.diff_prettyHtml2 = function(diffs) {
    var html = [];
    var pattern_amp = /&/g;
    var pattern_lt = /</g;
    var pattern_gt = />/g;
    ...
    for (var x = 0; x < diffs.length; x++) {
      ...
      switch (op) {
        case DIFF_INSERT:
          // html[x] = '<ins style="background:#e6ffe6;">' + text + '</ins>';
          html[x] = '<span class="insert2">' + text + '</span>';
          break;
        case DIFF_DELETE:
          // html[x] = '<del style="background:#ffe6e6;">' + text + '</del>';
          html[x] = '<span class="delete2">' + text + '</span>';
          break;
        case DIFF_EQUAL:
          // html[x] = '<span>' + text + '</span>';
          html[x] = data;
